...
const nextAppointment = () => {
    ...
    const fetchBooking = async () => {
        try {
            ...
            const response = await axios.get('http://192.168.0.107:8000/api/get_userbookings', {
                headers: {
                    ...
                    <View style={styles.bookingCard}>
                        <View style={styles.leftInside}>
                            <Image
                                ...
                                source={{ uri: `http://192.168.0.107:8000/storage/${bookingData?.hospital_detailes?.logo_url}` }}
                            />
                        </View>
